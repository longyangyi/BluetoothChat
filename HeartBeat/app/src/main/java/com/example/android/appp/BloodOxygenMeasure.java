...
public class BloodOxygenMeasure extends Activity {

    private String title = "血氧";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.blood_oxygen_measure_layout);
        CommonInstance.getInstance().addActivity(this);

        ActivityCompat.requestPermissions(BloodOxygenMeasure.this, new String[]{android
                .Manifest.permission.WRITE_EXTERNAL_STORAGE}, 1);

        context = getApplicationContext();
        //这里获得main界面上的布局，下面会把图表画在这个布局里面
        LinearLayout layout = (LinearLayout) findViewById(R.id.BloodOxygenChart);
        ...
        //设置好图表的样式
        setChartSettings(renderer, "X", "Y", 0, 10, 0, 115, Color.WHITE, Color.WHITE);
        ...
        BloodOxygenText = (TextView) findViewById(R.id.BloodOxygenChartTextValue);
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            Intent intent = new Intent(BloodOxygenMeasure.this, ChooseItem.class);
            Bundle b = new Bundle();
