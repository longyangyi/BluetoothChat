...
public class PersonalInfo extends AppCompatActivity {
    ...
    TextView id,DID,balance,phoneNumber,age,introduction;
    DataInputStream dis;
    Handler handler;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        introduction=(TextView) findViewById(R.id.introduction2);
        ...
        try {
            ...
            handler.post(new Runnable() {
                ...
                public void run() {
                    ...
                    introduction.setText(jo.getString("introduction"));
                }
            });
            runOnUiThread(new Runnable() {
                @Override
